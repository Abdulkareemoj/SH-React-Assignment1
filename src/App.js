...
function App() {
  return (
    <>
    <title>Abdulkareem's CV</title>
    <link
      href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css"
      rel="stylesheet"
    />
    {/* outer container */}
    <div className="border border-gray-300 rounded-sm shadow-lg content-center mx-20">
      {/* header (profile) */}
      <header>
        {/* social icons*/}
        ...
        <div className="flex justify-between items-center">
          ...
          <div>
            <h1 className="text-7xl font-extrabold">Abdulkareem Ojerinde</h1>
            <p className="text-xl mt-5">Aspiring Full-Stack Developer</p>
          </div>
        </div>
      </header>
      {/* detailed info */}
      <main className="flex gap-x-10 mt-10">
        <div className="w-2/6">
          ...
          <ul className="mt-2 mb-10">
            ...
            <li className="px-2 mt-1">
              ...
              <a href="mailto:" className="block">
                abdulkareemojerinde@gmail.com
              </a>
            </li>
            <li className="px-2 mt-1">
              <strong className="mr-1">Location</strong>
              <span className="block">Ibadan, Oyo State</span>
            </li>
          </ul>
          ...
          <ul className="mt-2 mb-10">
            <li className="px-2 mt-1">University of Cape Coast</li>
          ...
          <ul className="mt-2 mb-10">
            ...
            <li className="px-2 mt-1">NodeJS</li>
          </ul>
          <strong className="text-xl font-medium">Interests &amp; Hobbies</strong>
          <ul className="mt-2">
            <li className="px-2 mt-1">Video Editing</li>
            <li className="px-2 mt-1">New technologies</li>
            <li className="px-2 mt-1">Gaming</li>
